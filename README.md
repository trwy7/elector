...
services:
  electoric:
    image: ghcr.io/trwy7/elector:1.0.3 # You may want to update this with the latest release version. "latest" is mapped to the latest commit, not latest release, and it may contain bugs
    user: "10001:10001"
    environment:
